...
<body>
    ...
    <div class="container">
        <div class="card" style="background-color: blue; margin-top: 60px; margin-left: 25%; margin-right: 30%; padding: 5%;">
            <form class="form-horizontal" action="handlers/loginHandler.php" method="post">
                <div class="form-group">
                    <h2 style="text-align:center; color:white;">ACCIDENT PUSH</h2>
                </div>
                ...
                <div class="form-group">
                    <div class="position-relative has-icon-left">
                        <input name="username" type="text" style="width: 100%;" placeholder="User_name">
                    </div>
                </div>
                <div class="form-group">
                ...
                <span style="display:inline;">
                    <div style="text-align:right;color:white;">
                        <h5>Don't have an account?</h5><a href="register.php">
                            <h5 style="color:white;">register_now</h5>
                        </a>
                    </div>
                </span>
            </form>
