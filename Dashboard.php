...
require_once("functions/checkActiveSession.php");
...
<body>
    <div class="jumbotron">
        ...
        <div id="main">
            <div class="head">
                <div class="col-div-6">
                    <label style="font-weight: bold; font-size: 20px; text-align: center; color: white; padding-left: 10px; padding-top: 10px;">STATE UNIVERSITY OF ZANZIBAR (<?php echo $loggedInUser['Name']." | ". $loggedInUser['Email']; ?>)</label>
                </div>
                <div class="col-div-6">
                    <div class="profile">
